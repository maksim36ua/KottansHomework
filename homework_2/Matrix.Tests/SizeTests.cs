...
namespace Matrix.Tests
{
    public class SizeTests
    {
        ...
        [Test]
        public void NotEqualsOperator_WhenStructAIsNotEqualToB_ReturnsTrue()
        {
            var sizeA = new Size(2, 1);
            var sizeB = new Size(1, 1);
        ...
        public void NotEqualsOperator_WhenStructAIsEqualToB_ReturnsFalse()
        {
            var sizeA = new Size(1, 1);
            var sizeB = new Size(1, 1);
