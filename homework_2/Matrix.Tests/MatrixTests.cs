...
namespace Matrix.Tests
{
    public class MatrixTests
    {
        ...
        public void Constructor_WhenPassedArray_ReturnsCorrectSize()
        {
            ...
            var expectedSize = new Size(height: 3, width: 2);
        ...
        [Test]
        public void Indexer_UsingValueOutOfMatrixRange_ThrowsIndexOutOfRangeException()
        {
            CoolMatrix matrix = new[,]
            {
                { 1, 2 },
        ...
        [Test]
        public void NotEqalsOperator_WhenAllMembersAreEqual_ReturnsTrue()
        {
            CoolMatrix matrixA = new[,]
            {
                { 1, 2, 3 },
        ...
        [Test]
        public void NotEqualsOperator_WhenAnyMemberIsNotEqual_ReturnsFalse()
        {
            CoolMatrix matrixA = new[,]
            {
                { 0, 2 },
        ...
        [Test]
        public void EqualsMethod_TwoObjectsAreEqual_ReturnsTrue()
        {
            CoolMatrix matrix1 = new[,]
            {
                {1, 2},
                {3, 4}
            };

            CoolMatrix matrix2 = new[,]
            {
                {1, 2},
                {3, 4}
            };

            CoolMatrix matrix3 = matrix1;
        ...
        [Test]
        public void EqualsMethod_TwoObjectsAreNotEqual_ReturnsFalse()
        {
            CoolMatrix matrix1 = new[,]
            {
                {1, 2},
